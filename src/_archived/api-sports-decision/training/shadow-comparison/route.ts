...
type ShadowSport = Extract<Sport, "football" | "basketball" | "tennis">;
...
async function buildSlate(date: string, sport: ShadowSport, limit: number) {
...
export async function GET(request: Request) {
  ...
  const selectedSports = sports ?? (["football", "basketball", "tennis"] satisfies ShadowSport[]);
  ...
  return apiSuccess(
    buildLearnedWeightShadowComparison({
      date,
      oddsBoard,
      shadowCandidates,
      promotionGovernor,
