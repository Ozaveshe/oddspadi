...
export async function GET(request: Request) {
  ...
  if (!DECISION_MULTI_SPORTS.includes(query.sport as DecisionMultiSport)) {
    return apiError("Supabase authority remediation currently supports football, basketball, and tennis.");
  }
  ...
  return apiSuccess(context.supabaseAuthorityRemediation);
}
