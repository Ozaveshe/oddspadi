...
export async function GET(request: Request) {
  ...
  const verifier = buildDecisionEvidenceRefreshVerifier({ scheduler, signalReliability, dataIntake, modelTrust, portfolioRisk, oddsBoard });

  return apiSuccess(buildDecisionEvidenceTransition({ scheduler, verifier, signalReliability, dataIntake, modelTrust, portfolioRisk, oddsBoard }));
}
