...
const DOMAINS: Array<Omit<DecisionSupabaseStorageProofLedgerDomain, "localDeclared" | "localRlsProtected" | "localPublicRevoked" | "serviceGrantDeclared" | "liveVerified" | "mcpObserved" | "status" | "nextAction">> = [
  ...
  },
  {
    ...
    tables: ["op_model_versions", "op_decision_runs", "op_ai_thought_episodes", "op_decision_briefings", "op_prediction_outcomes", "op_shadow_predictions", "op_calibration_runs", "op_calibration_candidates", "op_calibration_promotions", "op_model_comparison_receipts", "op_shadow_memory_replay"],
    expectedTables: 11
  },
  {
