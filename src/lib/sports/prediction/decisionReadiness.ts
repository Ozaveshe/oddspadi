...
const ODDSPADI_SUPABASE_TABLE_PURPOSE: Record<string, SupabaseSchemaTableCheck["requiredFor"]> = {
  ...
  op_shadow_predictions: "learning-loop",
  op_calibration_runs: "learning-loop",
  op_calibration_candidates: "learning-loop",
  op_calibration_promotions: "learning-loop",
  op_model_comparison_receipts: "learning-loop",
