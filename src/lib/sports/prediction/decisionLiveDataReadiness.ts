...
const FAMILIES: FamilyDefinition[] = [
  ...
  },
  {
    ...
    tables: ["op_model_versions", "op_decision_runs", "op_prediction_outcomes", "op_shadow_predictions", "op_calibration_runs", "op_calibration_candidates", "op_calibration_promotions", "op_model_comparison_receipts", "op_ai_thought_episodes", "op_decision_briefings", "op_shadow_memory_replay"],
    feeds: []
  }
];
