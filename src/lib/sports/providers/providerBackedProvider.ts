...
// The matcher itself now lives in `teamNameAlignment` so offline loaders can
// import it without dragging the whole provider stack in; re-exported here
// because this is where every existing caller looks for it.
export { teamNamesAlign };
