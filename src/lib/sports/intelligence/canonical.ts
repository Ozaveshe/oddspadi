...
export function normalizeCanonicalFixture(match: Match, now = new Date()): CanonicalFixture {
  ...
  return {
    ...
    homeTeam: { id: match.homeTeam.id, name: match.homeTeam.name, logo: match.homeTeam.logo, country: match.homeTeam.country ?? match.league.country },
    awayTeam: { id: match.awayTeam.id, name: match.awayTeam.name, logo: match.awayTeam.logo, country: match.awayTeam.country ?? match.league.country },
