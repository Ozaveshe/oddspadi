...
export function normalizeCanonicalFixture(match: Match, now = new Date()): CanonicalFixture {
  ...
  return {
    ...
    homeTeam: { id: match.homeTeam.id, name: match.homeTeam.name, logo: match.homeTeam.logo, country: match.league.country },
    awayTeam: { id: match.awayTeam.id, name: match.awayTeam.name, logo: match.awayTeam.logo, country: match.league.country },
