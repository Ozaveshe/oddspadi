...
--
-- Rewrote `op_expire_stale_fixtures` to compute its candidate set in a
-- CTE.
--
-- Recorded in `supabase_migrations.schema_migrations` as `20260803115741
-- expire_stale_fixtures_cte`, applied through the Supabase MCP tool, which
-- assigns its own version at apply time rather than using a committed
-- filename. The change was folded into
-- `20260803150000_expire_stale_fixtures_cte.sql`, which is what a fresh
-- environment runs.
--
-- Verified against production 2026-08-07: The committed file of the same
-- name is recorded applied at 20260803150000.
--
