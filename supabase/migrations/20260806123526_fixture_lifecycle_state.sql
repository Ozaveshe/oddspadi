...
--
-- First apply of the derived fixture lifecycle state.
--
-- Recorded in `supabase_migrations.schema_migrations` as `20260806123526
-- fixture_lifecycle_state`, applied through the Supabase MCP tool, which
-- assigns its own version at apply time rather than using a committed
-- filename. The change was folded into
-- `20260806160000_fixture_lifecycle_state.sql`, which is what a fresh
-- environment runs.
--
-- Verified against production 2026-08-07: The committed file of the same
-- name is recorded applied at 20260806160000.
--
