...
--
-- Re-apply of the publication path while it was being iterated against
-- production.
--
-- Recorded in `supabase_migrations.schema_migrations` as `20260803104129
-- publication_path`, applied through the Supabase MCP tool, which assigns
-- its own version at apply time rather than using a committed filename.
-- The change was folded into `20260803040000_publication_path.sql`, which
-- is what a fresh environment runs.
--
-- Verified against production 2026-08-07: The committed file of the same
-- name is recorded applied at 20260803040000.
--
-- The committed file sorts *earlier* than this row, so on a fresh push the
-- real work runs first and this version is reached as a no-op.
--
