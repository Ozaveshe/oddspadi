...
--
-- First apply of the fixture temporal columns.
--
-- Recorded in `supabase_migrations.schema_migrations` as `20260806115425
-- fixture_temporal_columns`, applied through the Supabase MCP tool, which
-- assigns its own version at apply time rather than using a committed
-- filename. The change was folded into
-- `20260806130000_fixture_temporal_columns.sql`, which is what a fresh
-- environment runs.
--
-- Verified against production 2026-08-07: `op_fixtures.lifecycle_state`
-- and `lifecycle_state_at` both exist, and the committed file of the same
-- name is recorded applied at 20260806130000.
--
