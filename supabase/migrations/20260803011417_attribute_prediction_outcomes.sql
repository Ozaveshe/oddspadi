...
--
-- First apply of the outcome attribution change.
--
-- Recorded in `supabase_migrations.schema_migrations` as `20260803011417
-- attribute_prediction_outcomes`, applied through the Supabase MCP tool,
-- which assigns its own version at apply time rather than using a
-- committed filename. The change was folded into
-- `20260803011500_attribute_prediction_outcomes.sql`, which is what a
-- fresh environment runs.
--
-- Verified against production 2026-08-07: The committed file of the same
-- name is recorded applied at 20260803011500.
--
