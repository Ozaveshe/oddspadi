...
```bash
curl -X POST "http://localhost:3013/api/sports/decision/training/provider-sync?provider=api-football&league=39&season=2025&date=2025-08-01&includeEvents=1&includeNews=1&includeContext=1" \
