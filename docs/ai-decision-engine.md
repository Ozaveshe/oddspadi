...
- model-bound empirical value policy learned from final-posterior training observations, including one-sided 95% Wilson probability floors by canonical 10-point bucket
...
- require both edge and EV to remain positive at the empirical one-sided 95% outcome-rate floor for the selected final-posterior probability bucket; thin or missing buckets abstain
